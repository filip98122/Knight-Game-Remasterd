if 1 == 1:
    ...
    class Knight:
        ...
        def draw(self,window):
            ...
            if self.defend == True:
                if self.last_direction == 1:
                    self.sprite_img = pygame.image.load('defend.png')
                else:
                    self.sprite_img = pygame.image.load('defend1.png')
    ...
    class King:
        ...
        def draw(s,window):
            ...
            if s.hp >0:
                if s.time == 0:
                    s.time = 350
                if s.time <= 350 and s.time >300:
                    window.blit(s.scaled_img1,(900,500))
                    if s.time == 301:
                        s.spawn = True
                else:
                    window.blit(s.scaled_img,(900,560))
                s.time-=1
    class Button:
